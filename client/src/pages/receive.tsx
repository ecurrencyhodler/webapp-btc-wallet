...
export default function ReceivePage() {
  const { receiveAddress, receiveAddressIndex, verifyAddressOnDevice } = useLedger();
  ...
  const handleVerify = async () => {
    setIsVerifying(true);
    try {
      await verifyAddressOnDevice(receiveAddressIndex);
    } catch (e) {
    } finally {
        ...
        <CardContent className="p-8 flex flex-col items-center space-y-8">
          ...
          <div className="w-full space-y-3">
            <div className="flex items-center justify-center gap-2">
              ...
              <div className="text-xs bg-primary/20 text-primary px-2 py-0.5 rounded-full font-mono">
            ...
            <p className="text-xs text-muted-foreground text-center">
              This is a fresh address. Once it receives funds, a new one will be generated automatically.
            </p>
          </div>
